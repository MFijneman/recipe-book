            ...
            <div className="h-80 bg-gradient-to-br from-stone-100 via-neutral-100 to-stone-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 rounded-2xl flex items-center justify-center">
              <div className="text-center">
                <div className="bg-white/30 dark:bg-gray-600/30 backdrop-blur-sm rounded-2xl p-6 mb-4">
                  <svg className="mx-auto h-12 w-12 text-stone-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-stone-100/50 dark:bg-gray-700/50 rounded-2xl p-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    >
                      <svg className="w-4 h-4 text-stone-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid gap-3">
                  {recipe.ingredients.map((ingredient, index) => {
                    ...
                    if (!isNaN(Number(ingredient.amount)) && baseServings > 0) {
                      scaledAmount = (
                        Number(ingredient.amount) * (servings / baseServings)
                      ).toFixed(2).replace(/\.00$/, '');
                    }
                    return (
                      <div key={index} className="flex items-center space-x-4 p-3 bg-stone-50/50 dark:bg-gray-700/50 rounded-xl">
