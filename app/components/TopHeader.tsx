      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              {isDarkMode ? (
                <svg className="w-5 h-5 text-stone-700 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg className="w-4 h-4 text-stone-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {languages.map((lang) => (
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-2 text-left hover:bg-stone-100/50 dark:hover:bg-gray-700/50 transition-colors duration-200 ${
                          language === lang.code ? 'bg-stone-100/50 dark:bg-gray-700/50 text-stone-800 dark:text-stone-100' : 'text-stone-700 dark:text-gray-300'
                        }`}
                      >
                        <span className="text-lg">{lang.flag}</span>
                        <span className="text-sm font-medium">{lang.name}</span>
                        {language === lang.code && (
                          <svg className="w-4 h-4 ml-auto text-stone-600 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
