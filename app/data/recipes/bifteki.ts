...
const bifteki: Recipe = {
  ...
  description:
    'Greek-style minced beef patties stuffed with feta cheese, flavored with garlic, onion, mint, and spices, perfect for a hearty dinner.',
  cookTime: 10,
  prepTime: 50,
  totalTime: 60,
  difficulty: 'medium',
  image: 'bifteki.jpg',
  tags: ['dinner', 'greek', 'beef', 'stuffed'],
  ...
  tips: ['Ensure the feta is fully enclosed in the meat to prevent it from melting out during cooking.'],
};
